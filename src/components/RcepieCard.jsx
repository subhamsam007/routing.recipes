...
const RcepieCard = (props) => {
  ...
  return (
    <Link to={`/recipe/${id}`} className='block w-1/5 h-1/2 rounded-3xl overflow-hidden bg-blue-100 text-3xl text-center  p-5 space-x-5 '>
      ...
      <button className='bg-red-300 hover:bg-red-700 cursor-pointer text-black p-2 rounded-3xl text-xl'>View Recipe</button>
    </Link>
  )
}
